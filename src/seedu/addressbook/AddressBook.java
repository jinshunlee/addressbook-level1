...
public class AddressBook {
    ...
    private static final String COMMAND_SORT_DESC = "Displays all persons as a list sorted according to name.";
    private static final String COMMAND_SORT_EXAMPLE = COMMAND_SORT_DESC;
    ...
    private static ArrayList<String[]> getPersonsWithNameContainingAnyKeyword(Collection<String> keywords) {
        ...
        //creates another collection to list but makes a copy of the entire list //o(n) memory and slower than for loop
        keywords = keywords.stream().map(person->person.toLowerCase()).collect(Collectors.toList());
        for (String[] person : getAllPersonsInAddressBook()) {
            //make both wordsInName and matchedPerson so can easily ignore upper or lower case
    ...
    /**
     * Displays and sorts all persons in the address book to the user according to alphabetic order.
     *
     * @return feedback display message for the operation result
     */
